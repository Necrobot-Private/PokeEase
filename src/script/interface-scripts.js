...
$(window).ready(function() {
    ...
    for (var i = 0; i < 30; i++) {
        ...
        $('.content[data-category="pokemons"]').append('<div class="pokemon"><h1 class="name">'+pokemonNames[currentRandomPokemon]+'</h1><div class="image-container"><img src="https://cdn.rawgit.com/Necrobot-Private/PokemonGO-Assets/master/pokemon/' +currentRandomPokemon+ '.png"/></div><h3 class="cp">'+currentRandomCP+'</h3><h3 class="iv">'+currentRandomIV+'</h3></div>');
    }
    */
...
$(window).ready(function() {
    ...
    for (var i = 1; i <= 151; i++) {
        $('.content[data-category="pokedex"]').append('<div class="pokemon"><h1 class="name">'+i+'. '+pokemonNames[i]+'</h1><div class="image-container"><img src="https://cdn.rawgit.com/Necrobot-Private/PokemonGO-Assets/master/pokemon/' +i+ '.png"/></div><h3 class="caught">'+i+'</h3><h3 class="seen">'+i+'</h3></div>');
    }
